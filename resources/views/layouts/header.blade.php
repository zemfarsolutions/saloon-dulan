...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('public/css/') }}/vendor/pickers/pickadate/pickadate.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/css/') }}/vendor/pickers/flatpickr/flatpickr.min.css">
