            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $dt->rname }}</td>
                  <td> 
                    <a href="{{ route('users.edit', ['user' => $dt->id]) }}" ><button class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1" type="button">
                  ...
                  <form action="{{ route('users.delete', ['user' => $dt->id]) }}" method="POST" style="display: inline-block">
                    @csrf
