 ...
 <div class="page-title-container">
  <div class="row">
    ...
    <div class="col-12 col-md-7">
      <h1 class="mb-0 pb-0 display-4" id="title">Hair Dresser List</h1>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $dt->rname }}</td>
                  <td> 
                    <a href="{{ route('hairdresser.edit', ['user' => $dt->id]) }}" ><button class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1" type="button">
                  ...
                  <form action="{{ route('hairdresser.delete', ['user' => $dt->id]) }}" method="POST" style="display: inline-block">
                    @csrf
