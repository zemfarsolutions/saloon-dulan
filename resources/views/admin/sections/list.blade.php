      ...
      <div class="page-title-container">
        <div class="row">
          ...
          <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Sections List</h1>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $dt->name }}</td>
                  <td>@if($dt->is_assigned==0) Not Assigned @else Assigned @endif</td>
                  <td> 
                    <a href="{{ route('sections.edit', ['sections' => $dt->id]) }}" ><button class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1" type="button">
