 ...
 <div class="page-title-container">
  <div class="row">
    ...
    <div class="col-12 col-md-7">
      <h1 class="mb-0 pb-0 display-4" id="title">Appointments List</h1>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $dt->email }}</td>
                  <td>{{ $dt->phone }}</td>
                  <td>{{ $dt->ticket_id }}A</td>
                  @if($dt->serving_time == NULL)
                    @if($dt->is_discarded == 1)
                      <td>Dicarded</td>
                     @else
                      <td>Inque</td>
                    @endif
